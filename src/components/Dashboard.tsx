...
export function Dashboard({
  ...
  useEffect(() => {
    // Quando muda o dia selecionado no calendário, atualiza o campo data (caso não esteja editando)
  ...
  // --- BLOQUEIO DE HORÁRIOS JÁ SELECIONADOS ---
                    ...
                    <li key={a.id} className="appointment-item">
                      ...
                      <div className="appointment-actions-row">
                        ...
                        <button
                          ...
                          onClick={() =>
                            onToggleAppointmentAttendance(a.id)
                          }
                        >
                          {isAttended
                            ? 'Presença confirmada'
